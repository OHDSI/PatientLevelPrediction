...
#' }
#' @export
setDecisionTree2 <- function(maxDepth=10 ,minSamplesSplit=2 ,minSamplesLeaf=10,
  ...
  result <- list(model='fitDecisionTree2', 
...
fitDecisionTree2 <- function(population, plpData, param, search='grid', quiet=F,
                             outcomeId, cohortId , ...){
  ...
  hyperParamSel <- lapply(param, function(x) do.call(trainDecisionTree2, 
  ...
  finalModel <- do.call(trainDecisionTree2, listAppend(param[[bestInd]], list(train=FALSE,
                                                                             population = pPopulation, 
                                                                             plpData = pydata, 
                                                                             quiet=quiet, 
                                                                             var=var,
...
trainDecisionTree2 <- function(population, plpData, 
