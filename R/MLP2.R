...
#' }
#' @export
setMLP2 <- function(size=4, alpha=0.00001, seed=NULL){
...
fitMLP2 <- function(population, plpData, param, search='grid', quiet=F,
                      outcomeId, cohortId, ...){
  ...
  finalModel <- do.call(trainMLP2, listAppend(param[[bestInd]], 
                                             list(plpData = pydata,
                                                  population = pPopulation,
                                                  train=FALSE,
                                                  quiet = quiet,
...
trainMLP2 <- function(plpData, population, size=1, alpha=0.001, seed=NULL, train=TRUE, quiet=F, modelOutput){
