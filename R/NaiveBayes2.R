...
#' }
#' @export
setNaiveBayes2 <- function(variableNumber=2000){
  ...
  result <- list(model='fitNaiveBayes2', name='Naive Bayes', param= list('variableNumber'=variableNumber))
  class(result) <- 'modelSettings' 
  
  return(result)
}

fitNaiveBayes2 <- function(population, plpData, param, search='grid', quiet=F,
                      outcomeId, cohortId, ...){
