.smallTtestCode <- function() {
  ...
  # cohortData <- loadCohortData('s:/temp/smallPlp/cohortData') covariateData <-
  # loadCovariateData('s:/temp/smallPlp/covariateData') outcomeData <-
  # loadOutcomeData('s:/temp/smallPlp/outcomeData')
