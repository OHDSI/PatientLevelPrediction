...
Here we provide a set of phenotypes that can be used as predictors in
prediction models or best practice research.

These phenotypes can be extracted from the PhenotypeLibrary R package.
...
To extract the cohort definition for Alcoholism with an id of 1165, just
run:
