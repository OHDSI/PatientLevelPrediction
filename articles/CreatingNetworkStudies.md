...
use the `PatientLevelPrediction` package to create a network study
package.
...
death in those who have covid-19.
...
- Write an R package for implementing the study across diverse
  ...
  package and use the skeleton github package here:
...
will be alphabetical by last name.
...
- main.r: this file will call the functions in helpers.r to execute the
  full study
- submit.r: this file will be called at the end to submit the compressed
  folder to the study creator/manager.
...
- Inst
- sql/sql_sever \* targetCohort: the target cohort parameterised sql
  code \* outcomeCohort: the outcome cohort parameterised sql code
