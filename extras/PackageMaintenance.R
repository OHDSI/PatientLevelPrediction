...
system("rm extras/ensembleLearning.pdf")
system("R CMD Rd2pdf ./ --output=extras/ensembleLearning.pdf")
rmarkdown::render("vignettes/ensembleLearning.Rmd",
                  output_file = "../inst/doc/ensembleLearning.pdf",
                  rmarkdown::pdf_document(latex_engine = "pdflatex",
                                          toc = TRUE,
                                          number_sections = TRUE))


rmarkdown::render("vignettes/BuildingMultiplePredictionModels.Rmd",
                  output_file = "../inst/doc/BuildingMultiplePredictionModel.pdf",
                  rmarkdown::pdf_document(latex_engine = "pdflatex",
                                          toc = TRUE,
                                          number_sections = TRUE))
