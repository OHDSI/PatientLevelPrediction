...
#' cohort. The cohort is assumed to be in an existing temp table with these fields: 'subject_id', 'cohort_definition_id', 
#' 'cohort_start_date'. Optionally, an extra field can be added containing the unique identifier that will be used as rowID
#' in the output.
#' 
...
#' @param cohortTempTable           Name of the temp table holding the cohort for which we want to construct covaraites
#' @param rowIdField                The name of the field in the cohort temp table that is to 
