...
**Important**: Make sure the same prediction window definition (e.g. `useCohortEndDate` and `windowPersistence`) is used when calling both `getDbCohortData` and `getDbOutcomeData`.
