...
Note: another way to add custom covariates is by using the `cohort_attribute` table in the common data model. This approach is described in the vignette called `reating covariates using cohort attributes`.
