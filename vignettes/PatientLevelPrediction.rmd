...
* Close your RStudio
* Install python 3.7 using anaconda (https://www.anaconda.com/download) and note the installation location. Anaconda should update you path variable with the python binary.
