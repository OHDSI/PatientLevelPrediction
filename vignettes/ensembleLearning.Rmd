...
to form a better but not optimum one.

Ensemble models yield better results for multiple models with signficant diversity, and also ensemble strategies can also paly a curical role. Currently, many ensemble strategies have been proposed.
...
2. ensemble with product rule: Claculate the product of probabilites from different models.
